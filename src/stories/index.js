...
import { BarStat, Badge, Button, Paper } from '../../src';
...
BarStatStories.add('with percent', () => (
  <BarStat percent={number('bar percentage', 45)} />
));

storiesOf('Badge', module).add('with some emoji', () => {
  const divStyle = {
    marginBottom: '10px',
  };
